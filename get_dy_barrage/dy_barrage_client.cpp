...
int dy_barrage_client::get_dy_barr_num()
{
    return barr_count;
}
...
int dy_barrage_client::get_room_status(int room_id)
{
    char a[100]="wget ";
...
int dy_barrage_client::get_online_num()
{
        FILE * pFile;
    long size;
    char * buffer;
